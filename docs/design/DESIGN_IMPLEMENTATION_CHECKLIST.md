...
> Based on docs/design/DESIGN_GUIDE.md v1.0 - "Native Neutral" Concept
...
- [x] Design guide documented (docs/design/DESIGN_GUIDE.md)
...
```
ClipKeyboard/
├── docs/design/DESIGN_GUIDE.md (reference doc)
├── docs/design/DESIGN_IMPLEMENTATION_CHECKLIST.md (this file)
├── Extensions/
...
2. App passes design review against docs/design/DESIGN_GUIDE.md
