...
한 단축어에 여러 값을 담고, 앱·키보드에서 골라 쓰세요. 새 단축어 화면도 더 심플하고 또렷해졌고, 아이폰과 맥 사이 단축어 동기화도 제대로 맞물리게 손봤어요.
...
Put several values in one snippet and pick which to use — right in the app or the keyboard. The new-snippet screen is cleaner and clearer, and snippet sync between iPhone and Mac now actually lines up.
