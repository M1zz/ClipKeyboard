...
1. CloudKit Dashboard에 `UsageSnapshot`/`UsageEvent` 스키마 생성 → 인덱스 → **Production 배포** (`docs/engineering/USAGE_STATS_HUB.md`)
...
- App Store Connect **App Privacy** → 답안 확정 완료: `docs/product/APP_PRIVACY_ANSWERS.md` (콘솔 입력만 남음)
- ✅ 문구 정리 완료 (2026-07-30), "아무것도 수집 안 함" 주장이 있던 **6개 문서** 수정:
  `privacy.html`(ko·en 사전 포함) · `index.html` · `tutorial.html` · `docs/marketing/ASO_2026-07.md`(스토어 설명 원고) ·
  `README.md` · `docs/release-notes/4.4.3.md`(수집 고지 추가)
...
- 수집 신고 6종: Product Interaction · Purchase History · Device ID(익명 설치 UUID) ·
  Customer Support · Email · Name → 답안서 `docs/product/APP_PRIVACY_ANSWERS.md`
...
**P3-4. 마케팅 발행**: `docs/marketing/ASO_2026-07.md`, `docs/marketing/MARKETING_PLAN_2026-07.md`, `docs/marketing/KR_COMMUNITY_POSTS.md`, `docs/marketing/PRODUCT_HUNT_LAUNCH.md`가 **다 쓰여 있는데 발행이 안 됐다**(포트폴리오 리포트: "실제 발행·이벤트·캠페인 미진행").
